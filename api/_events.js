...
// June 6 2026 = Saturday | June 8 = Monday | June 11 = Thursday | June 17 = Wednesday (FOMC)

export const EVENTS = [

  // ══ SEMANA 1 — Jun 9-13 ════════════════════════════════════════════════
  // NFP May — YA LIBERADO (Miss fuerte: 139K vs 185K forecast → bullish gold)
  ...
  // Jueves 11 Jun
  { id:'claims-2026-06a', name:'Initial Jobless Claims',          date:'2026-06-12T08:30:00-04:00', importance:'medium', prev:229,  fc:225,  actual:null },
  ...
  { id:'umich-2026-06a',  name:'Michigan Sentiment Prel. (Jun)',  date:'2026-06-13T10:00:00-04:00', importance:'medium', prev:52.2, fc:53.0, actual:null },

  // ══ SEMANA 2 — Jun 15-20 ═══════════════════════════════════════════════
  // Lunes 15 Jun
  { id:'empire-2026-06',  name:'Empire Manufacturing (Jun)',       date:'2026-06-16T08:30:00-04:00', importance:'medium', prev:-8.1, fc:-5.0, actual:null },

  // Martes 16 Jun
  { id:'retail-2026-06',  name:'Retail Sales MoM (May)',          date:'2026-06-17T08:30:00-04:00', importance:'medium', prev:0.1,  fc:0.2,  actual:null },
  { id:'indpro-2026-06',  name:'Industrial Production (May)',      date:'2026-06-17T09:15:00-04:00', importance:'medium', prev:0.3,  fc:0.2,  actual:null },

  // Miércoles 17 Jun ← FOMC
  { id:'housing-2026-06', name:'Housing Starts (May)',             date:'2026-06-18T08:30:00-04:00', importance:'medium', prev:1.36, fc:1.34, actual:null },
  { id:'fomc-2026-06',    name:'FOMC Rate Decision',               date:'2026-06-18T14:00:00-04:00', importance:'high',   prev:4.25, fc:4.25, actual:null },

  // Jueves 18 Jun
  { id:'claims-2026-06b', name:'Initial Jobless Claims',          date:'2026-06-19T08:30:00-04:00', importance:'medium', prev:229,  fc:227,  actual:null },
  { id:'philly-2026-06',  name:'Philly Fed Manufacturing (Jun)',   date:'2026-06-19T08:30:00-04:00', importance:'medium', prev:-4.0, fc:-2.0, actual:null },

  // Viernes 19 Jun
  { id:'exhome-2026-06',  name:'Existing Home Sales (May)',        date:'2026-06-20T10:00:00-04:00', importance:'medium', prev:4.0,  fc:4.1,  actual:null },

  // ══ SEMANA 3 — Jun 22-27 ═══════════════════════════════════════════════
  // Martes 23 Jun
  { id:'pmi-2026-06',     name:'S&P Global PMI Composite (Jun)',  date:'2026-06-23T09:45:00-04:00', importance:'medium', prev:52.1, fc:52.0, actual:null },
  { id:'newhome-2026-06', name:'New Home Sales (May)',             date:'2026-06-24T10:00:00-04:00', importance:'medium', prev:743,  fc:730,  actual:null },

  // Miércoles 24 Jun
  { id:'durable-2026-06', name:'Durable Goods Orders MoM (May)',  date:'2026-06-25T08:30:00-04:00', importance:'medium', prev:7.4,  fc:0.3,  actual:null },

  // Jueves 25 Jun
  { id:'claims-2026-06c', name:'Initial Jobless Claims',          date:'2026-06-26T08:30:00-04:00', importance:'medium', prev:229,  fc:225,  actual:null },
  { id:'gdp-2026-q1f',    name:'GDP Q1 Final (YoY)',              date:'2026-06-26T08:30:00-04:00', importance:'medium', prev:-0.3, fc:-0.2, actual:null },

  // Viernes 26 Jun ← PCE Core (event más vigilado por la Fed)
  { id:'pce-2026-06',     name:'PCE Core YoY (May)',              date:'2026-06-27T08:30:00-04:00', importance:'high',   prev:2.6,  fc:2.6,  actual:null },
  { id:'umich-2026-06b',  name:'Michigan Sentiment Final (Jun)',   date:'2026-06-27T10:00:00-04:00', importance:'medium', prev:52.2, fc:53.0, actual:null },

  // ══ SEMANA 4 — Jun 30 – Jul 4 ══════════════════════════════════════════
  // Lunes 29 Jun
  { id:'psi-2026-06',     name:'Personal Income/Spending (May)',  date:'2026-06-30T08:30:00-04:00', importance:'medium', prev:0.5,  fc:0.4,  actual:null },
  ...
  // Miércoles 1 Jul
  { id:'adp-2026-07',     name:'ADP Employment (Jun)',             date:'2026-07-01T08:15:00-04:00', importance:'medium', prev:152,  fc:140,  actual:null },
  ...
  // Jueves 2 Jul ← NFP movido (4 Jul = Sábado, observado Vie 3 = holiday)
  { id:'nfp-2026-07',     name:'Non-Farm Payrolls (Jun)',          date:'2026-07-02T08:30:00-04:00', importance:'high',   prev:139,  fc:160,  actual:null },
  { id:'claims-2026-07a', name:'Initial Jobless Claims',           date:'2026-07-02T08:30:00-04:00', importance:'medium', prev:229,  fc:225,  actual:null },
  ...
  { id:'claims-2026-07b', name:'Initial Jobless Claims',           date:'2026-07-10T08:30:00-04:00', importance:'medium', prev:229,  fc:225,  actual:null },
  ...
  // ══ SEMANA 6 — Jul 14-18 ═══════════════════════════════════════════════
  // Martes 14 Jul
  { id:'cpi-2026-07',     name:'CPI YoY (Jun)',                   date:'2026-07-15T08:30:00-04:00', importance:'high',   prev:2.3,  fc:null, actual:null },

  // Miércoles 15 Jul
  { id:'ppi-2026-07',     name:'PPI MoM (Jun)',                   date:'2026-07-16T08:30:00-04:00', importance:'medium', prev:0.2,  fc:null, actual:null },
  { id:'retail-2026-07',  name:'Retail Sales MoM (Jun)',          date:'2026-07-16T08:30:00-04:00', importance:'medium', prev:0.2,  fc:null, actual:null },

  // Jueves 16 Jul
  { id:'claims-2026-07c', name:'Initial Jobless Claims',          date:'2026-07-17T08:30:00-04:00', importance:'medium', prev:null, fc:null, actual:null },
  { id:'philly-2026-07',  name:'Philly Fed Manufacturing (Jul)',  date:'2026-07-17T08:30:00-04:00', importance:'medium', prev:null, fc:null, actual:null },

  // Viernes 17 Jul
  { id:'umich-2026-07b',  name:'Michigan Sentiment Final (Jul)',  date:'2026-07-18T10:00:00-04:00', importance:'medium', prev:null, fc:null, actual:null },

  // ══ FIN DE JULIO — FOMC + GDP ═══════════════════════════════════════════
  { id:'fomc-2026-07',    name:'FOMC Rate Decision',              date:'2026-07-30T14:00:00-04:00', importance:'high',   prev:4.25, fc:4.25, actual:null },
  { id:'gdp-2026-q2a',    name:'GDP Q2 Advance (YoY)',            date:'2026-07-30T08:30:00-04:00', importance:'high',   prev:null, fc:null,  actual:null },
  ...
  { id:'pce-2026-09',     name:'PCE Core YoY (Aug)',              date:'2026-09-26T08:30:00-04:00', importance:'high',   prev:null, fc:null, actual:null },
  ...
  { id:'fomc-2026-11',    name:'FOMC Rate Decision',              date:'2026-11-05T14:00:00-05:00', importance:'high',   prev:4.25, fc:4.25, actual:null },
